...
public enum EventType {
	...
	REFUND_STATUS_SUCCESS, REFUND_STATUS_FAILED,

	ORDER_STATUS_SUCCESS, ORDER_STATUS_FAILED,

	TRANSACTION_STATUS_SUCCESS, TRANSACTION_STATUS_FAILED,

	CREATE_SDK_ORDER_SUCCESS, CREATE_SDK_ORDER_FAILED,

	STANDARD_CHECKOUT_CLIENT_INITIALIZED, CUSTOM_CHECKOUT_CLIENT_INITIALIZED, TOKEN_SERVICE_INITIALIZED,
	...
	SETUP_SUCCESS, SETUP_FAILED,

	NOTIFY_SUCCESS, NOTIFY_FAILED,

	REDEEM_SUCCESS, REDEEM_FAILED,

	CANCEL_SUCCESS, CANCEL_FAILED,

	SUBSCRIPTION_STATUS_SUCCESS, SUBSCRIPTION_STATUS_FAILED,
}
