...
public class BaseEvent {
	...
	public static BaseEvent buildStandardCheckoutPayEvent(
			...
			EventType eventName,
			Exception exception) {
		BaseEvent baseEvent = buildStandardCheckoutPayEvent(
	...
	public static BaseEvent buildCustomCheckoutPayEvent(
		...
		// Extracting the instrument from the PgPaymentFlow (null-safe: non-PG flows return null)
		PgPaymentFlow pgPaymentFlow = pgPaymentRequest.getPaymentFlow() instanceof PgPaymentFlow
				? (PgPaymentFlow) pgPaymentRequest.getPaymentFlow()
				: null;
		...
		String targetApp = Optional.ofNullable(pgPaymentFlow)
				...
				.filter(
						paymentMode -> paymentMode.getType()
	...
	public static BaseEvent buildOrderStatusEvent(
			...
			EventType eventName,
			Exception exception) {
		BaseEvent baseEvent = buildOrderStatusEvent(eventState, merchantOrderId, apiPath, flowType, eventName);
		return populateExceptionFields(baseEvent, exception);
	}
	...
	public static BaseEvent buildCreateSdkOrderEvent(
			...
			EventType eventName,
			Exception exception) {
		BaseEvent baseEvent = buildCreateSdkOrderEvent(
	...
	public static BaseEvent buildTransactionStatusEvent(
			...
			EventType eventName,
			Exception exception) {
		BaseEvent baseEvent = buildTransactionStatusEvent(
								...
								.subscriptionEventData(
										SubscriptionEventData.builder()
												...
												.subscriptionExpireAt(
														Optional.ofNullable(setupPaymentFlow)
																.map(
																		SubscriptionSetupPaymentFlow::getExpireAt)
																.orElse(null))
												.merchantSubscriptionId(
														Optional.ofNullable(setupPaymentFlow)
																.map(
																		SubscriptionSetupPaymentFlow::getMerchantSubscriptionId)
																.orElse(null))
												.build())
								.build())
				.build();
	...
	public static BaseEvent buildSubscriptionNotifyEvent(
			...
			String apiPath,
			EventType eventName) {
		SubscriptionRedemptionPaymentFlow paymentFlow = (SubscriptionRedemptionPaymentFlow) notifyRequest
				.getPaymentFlow();
		return BaseEvent.builder()
				.eventName(eventName)
				.eventTime(Instant.now()
	...
	public static BaseEvent buildSubscriptionStatusEvent(
			...
			EventType eventName,
			Exception exception) {
		BaseEvent event = buildSubscriptionStatusEvent(
	...
	public static BaseEvent buildSubscriptionCancelEvent(
			...
			EventType eventName,
			Exception exception) {
		BaseEvent event = buildSubscriptionCancelEvent(
				eventState, merchantSubscriptionId, apiPath, eventName);
		return populateExceptionFields(event, exception);
	}
