...
public class BaseEvent {
     ...
     */
    public static BaseEvent buildStandardCheckoutPayEvent(EventState eventState,
            StandardCheckoutPayRequest standardCheckoutPayRequest,
            String apiPath, EventType eventName) {
        return BaseEvent.builder()
                .eventName(eventName)
                .eventTime(Instant.now()
                        .getEpochSecond())
    ...
    public static BaseEvent buildStandardCheckoutPayEvent(EventState eventState,
            StandardCheckoutPayRequest standardCheckoutPayRequest,
            String apiPath, EventType eventName, Exception exception) {
        BaseEvent baseEvent = buildStandardCheckoutPayEvent(eventState, standardCheckoutPayRequest, apiPath, eventName);
     ...
     */
    public static BaseEvent buildCustomCheckoutPayEvent(EventState eventState,
        ...
        String targetApp = Optional.ofNullable(pgPaymentFlow)
                ...
                .filter(paymentMode -> paymentMode.getType()
                        .equals(PgV2InstrumentType.UPI_INTENT))
        ...
        return BaseEvent.builder()
                ...
                .data(EventData.builder()
                        ...
                        .targetApp(targetApp)
                        .paymentInstrument(Optional.ofNullable(pgPaymentFlow)
                                .map(PgPaymentFlow::getPaymentMode)
    ...
    public static BaseEvent buildCustomCheckoutPayEvent(EventState eventState,
            PgPaymentRequest pgPaymentRequest,
            String url, EventType eventName, Exception exception) {
        BaseEvent baseEvent = buildCustomCheckoutPayEvent(eventState, pgPaymentRequest, url, eventName);
        return populateExceptionFields(baseEvent, exception);
    }
     ...
     */
    public static BaseEvent buildOrderStatusEvent(EventState eventState, String merchantOrderId, String apiPath,
            FlowType flowType, EventType eventName) {
        return BaseEvent.builder()
                .eventName(eventName)
                .eventTime(Instant.now()
                        .getEpochSecond())
    ...
    public static BaseEvent buildOrderStatusEvent(EventState eventState, String merchantOrderId, String apiPath,
            FlowType flowType, EventType eventName,
            Exception exception) {
        BaseEvent baseEvent = buildOrderStatusEvent(eventState, merchantOrderId, apiPath, flowType,
                eventName);
        return populateExceptionFields(baseEvent, exception);
    }
     ...
     */
    public static BaseEvent buildRefundEvent(EventState eventState, RefundRequest refundRequest,
            String apiPath, FlowType flowType, EventType eventName) {
        return BaseEvent.builder()
                .eventName(eventName)
                .eventTime(Instant.now()
                        .getEpochSecond())
     ...
     */
    public static BaseEvent buildRefundEvent(EventState eventState, RefundRequest refundRequest,
            String apiPath, FlowType flowType, EventType eventName, Exception exception) {
        BaseEvent baseEvent = buildRefundEvent(eventState, refundRequest, apiPath, flowType, eventName);
        return populateExceptionFields(baseEvent, exception);
    }
     ...
     */
    public static BaseEvent buildRefundStatusEvent(EventState eventState, String refundId, String apiPath,
            FlowType flowType, EventType eventName) {
        return BaseEvent.builder()
                .eventName(eventName)
                .eventTime(Instant.now()
     ...
     */
    public static BaseEvent buildRefundStatusEvent(EventState eventState, String refundId, String apiPath,
            FlowType flowType, EventType eventName, Exception exception) {
        BaseEvent baseEvent = buildRefundStatusEvent(eventState, refundId, apiPath, flowType, eventName);
        return populateExceptionFields(baseEvent, exception);
    }
     ...
     */
    public static BaseEvent buildCreateSdkOrderEvent(EventState eventState, CreateSdkOrderRequest createSdkOrderRequest,
            String apiPath, FlowType flowType, EventType eventName) {
        return BaseEvent.builder()
    ...
    public static BaseEvent buildCreateSdkOrderEvent(EventState eventState, CreateSdkOrderRequest createSdkOrderRequest,
            String apiPath, FlowType flowType, EventType eventName, Exception exception) {
        BaseEvent baseEvent = buildCreateSdkOrderEvent(eventState, createSdkOrderRequest, apiPath, flowType,
                eventName);
        return populateExceptionFields(baseEvent, exception);
    }
     ...
     */
    public static BaseEvent buildTransactionStatusEvent(EventState eventState, String transactionId,
            String apiPath, FlowType flowType, EventType eventName) {
        return BaseEvent.builder()
                .eventName(eventName)
                .eventTime(Instant.now()
     ...
     */
    public static BaseEvent buildTransactionStatusEvent(EventState eventState, String transactionId, String apiPath,
            FlowType flowType, EventType eventName, Exception exception) {
        BaseEvent baseEvent = buildTransactionStatusEvent(eventState, transactionId, apiPath, flowType, eventName);
        return populateExceptionFields(baseEvent, exception);
    }
     ...
     */
    public static BaseEvent buildSubscriptionSetupEvent(EventState eventState, PgPaymentRequest setupRequest,
            String apiPath, EventType eventName) {
        ...
        String targetApp = Optional.ofNullable(setupPaymentFlow)
        ...
        return BaseEvent.builder()
                ...
                .data(EventData.builder()
                        ...
                        .paymentInstrument(Optional.ofNullable(setupPaymentFlow)
                                .map(SubscriptionSetupPaymentFlow::getPaymentMode)
                                .map(PaymentV2Instrument::getType)
                                .orElse(null))
                        .targetApp(targetApp)
                        ...
                        .subscriptionEventData(SubscriptionEventData.builder()
                                .orderExpireAt(setupRequest.getExpireAt())
                                .subscriptionExpireAt(Optional.ofNullable(setupPaymentFlow)
                                        .map(SubscriptionSetupPaymentFlow::getExpireAt)
                                        .orElse(null))
                                .merchantSubscriptionId(Optional.ofNullable(setupPaymentFlow)
                                        .map(SubscriptionSetupPaymentFlow::getMerchantSubscriptionId)
                                        .orElse(null))
                                .build())
                        .build())
                .build();
     ...
     */
    public static BaseEvent buildSubscriptionNotifyEvent(EventState eventState, PgPaymentRequest notifyRequest,
            String apiPath,
            EventType eventName) {
        ...
        return BaseEvent.builder()
                ...
                .data(EventData.builder()
                        ...
                        .subscriptionEventData(SubscriptionEventData.builder()
                                ...
                                .merchantSubscriptionId(paymentFlow.getMerchantSubscriptionId())
                                .build())
                        .build())
                .build();
    }
    ...
    public static BaseEvent buildSubscriptionNotifyEvent(EventState eventState, PgPaymentRequest notifyRequest,
            String apiPath,
            EventType eventName, Exception exception) {
        BaseEvent event = buildSubscriptionNotifyEvent(eventState, notifyRequest, apiPath, eventName);
        return populateExceptionFields(event, exception);
    }

    public static BaseEvent buildSubscriptionRedeemEvent(EventState eventState, String merchantOrderId, String apiPath,
            EventType eventName) {
        return BaseEvent.builder()
                .eventTime(Instant.now()
                        .getEpochSecond())
    ...
    public static BaseEvent buildSubscriptionRedeemEvent(EventState eventState, String merchantOrderId, String apiPath,
            EventType eventName, Exception exception) {
        BaseEvent event = buildSubscriptionRedeemEvent(eventState, merchantOrderId, apiPath, eventName);
        return populateExceptionFields(event, exception);
    }
     ...
     * Order Status Event Builder
     */
    public static BaseEvent buildSubscriptionStatusEvent(EventState eventState, String merchantSubscriptionId,
            String apiPath,
            EventType eventName) {
        return BaseEvent.builder()
                .eventName(eventName)
    ...
    public static BaseEvent buildSubscriptionStatusEvent(EventState eventState, String merchantSubscriptionId,
            String apiPath,
            EventType eventName, Exception exception) {
        BaseEvent event = buildSubscriptionStatusEvent(eventState, merchantSubscriptionId, apiPath, eventName);
        return populateExceptionFields(event, exception);
    }

    public static BaseEvent buildSubscriptionCancelEvent(EventState eventState, String merchantSubscriptionId,
            String apiPath, EventType eventName) {
        return BaseEvent.builder()
                .eventTime(Instant.now()
                        .getEpochSecond())
    ...
    public static BaseEvent buildSubscriptionCancelEvent(EventState eventState, String merchantSubscriptionId,
            String apiPath, EventType eventName, Exception exception) {
        BaseEvent event = buildSubscriptionCancelEvent(eventState, merchantSubscriptionId, apiPath, eventName);
        return populateExceptionFields(event, exception);
    }
     ...
     */
    public static BaseEvent buildOAuthEvent(long fetchAttemptTime, String apiPath, EventType eventName,
            Exception exception, long cachedTokenIssuedAt, long cachedTokenExpiresAt) {
    ...
    public static BaseEvent buildCallbackSerializationFailedEvent(EventState eventState, FlowType flowType,
            EventType eventName, Exception exception) {
        BaseEvent baseEvent = BaseEvent.builder()
                .eventName(eventName)
                .eventTime(Instant.now()
    ...
    private static BaseEvent populateExceptionFields(BaseEvent baseEvent, Exception exception) {
        ...
        baseEvent.data.setExceptionClass(exception.getClass()
                .getSimpleName());
