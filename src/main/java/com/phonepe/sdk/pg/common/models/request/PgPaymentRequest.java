...
public class PgPaymentRequest {
	...
	@Builder(
			builderClassName = "UpiCollectPayViaVpaRequestBuilder", builderMethodName = "UpiCollectPayViaVpaRequestBuilder")
	public PgPaymentRequest(
			long amount,
			String merchantOrderId,
			MetaInfo metaInfo,
	...
	@Builder(
			builderClassName = "SubscriptionSetupUpiCollectBuilder", builderMethodName = "SubscriptionSetupUpiCollectBuilder")
	public PgPaymentRequest(
			String merchantOrderId,
			String merchantSubscriptionId,
			Long amount,
