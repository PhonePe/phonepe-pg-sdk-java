...
public class StandardCheckoutClient extends BaseClient {
	...
	public StandardCheckoutPayResponse pay(StandardCheckoutPayRequest standardCheckoutPayRequest) {
		...
		try {
			StandardCheckoutPayResponse standardCheckoutPayResponse = requestViaAuthRefresh(
					HttpMethodType.POST,
	...
	public CallbackResponse validateCallback(
			String username, String password, String authorization, String responseBody) throws PhonePeException {
