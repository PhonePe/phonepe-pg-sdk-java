...
public class CreateSdkOrderRequest {
	 ...
	 */
	@Builder(
			builderClassName = "StandardCheckoutBuilder", builderMethodName = "StandardCheckoutBuilder")
	 ...
	 */
	@Builder(
			builderClassName = "CustomCheckoutBuilder", builderMethodName = "CustomCheckoutBuilder")
	public CreateSdkOrderRequest(
			@NotNull String merchantOrderId,
			long amount,
			MetaInfo metaInfo,
