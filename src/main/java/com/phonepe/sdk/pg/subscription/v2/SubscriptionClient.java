...
public class SubscriptionClient extends BaseClient {
	...
	public PgPaymentResponse setup(PgPaymentRequest request) {
		...
		try {
			PgPaymentResponse response = requestViaAuthRefresh(
					HttpMethodType.POST,
					request,
					url,
					null,
	...
	public SubscriptionRedeemResponseV2 redeem(String merchantOrderId) {
		...
		try {
			...
			SubscriptionRedeemResponseV2 response = requestViaAuthRefresh(
					HttpMethodType.POST,
					request,
					url,
					null,
	...
	public SubscriptionStatusResponseV2 getSubscriptionStatus(String merchantSubscriptionId) {
		...
		try {
			SubscriptionStatusResponseV2 response = requestViaAuthRefresh(
					HttpMethodType.GET,
					null,
					url,
					null,
	...
	public OrderStatusResponse getOrderStatus(String merchantOrderId) {
		...
		try {
			OrderStatusResponse response = requestViaAuthRefresh(
					HttpMethodType.GET,
					null,
					url,
					null,
