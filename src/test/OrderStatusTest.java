...
class OrderStatusTest extends BaseSetupWithOAuth {
    ...
    void orderStatusForSplitInstruments() {
        ...
        String url = String.format(StandardCheckoutConstants.ORDER_STATUS_API, merchantOrderId);
        String response =
                "{\"orderId\":\"OMO2402281351151884090310\",\"state\":\"COMPLETED\",\"amount\":300,"
        ...
        addStubForGetRequest(
                url,
                ImmutableMap.of(StandardCheckoutConstants.ORDER_DETAILS, "true"),
                headers,
                HttpStatus.SC_OK,
                ImmutableMap.of(),
                response);

        OrderStatusResponse responeToObject =
                OrderStatusResponse.builder()
                        .orderId("OMO2402281351151884090310")
                        .state("COMPLETED")
                        .amount(300)
                        .expireAt(1709108893)
                        .metaInfo(MetaInfo.builder().udf1("udf1").build())
                        .paymentDetails(
                                Arrays.asList(
    ...
    void testTokenSuccess() {
        ...
        String response =
                "{\"orderId\":\"OMO2402281351151884090310\",\"state\":\"COMPLETED\",\"amount\":300,"
                    + "\"expireAt\":1709108893,\"metaInfo\":{\"udf1\":\"udf1\"},"
                    + "\"paymentDetails\":[{\"transactionId\":\"OM2402281351157894090178\","
                    + "\"paymentMode\":\"TOKEN\",\"timestamp\":1709108475,\"amount\":300,\"state\":\"COMPLETED\",\"splitInstruments\":[{\"instrument\""
                    + " : {\"type\":\"CREDIT_CARD\",\"bankTransactionId\":\"123\",\"bankId\":\"bankId\",\"brn\":\"brn\",\"arn\":\"arn\"},"
                    + " \"rail\":{\"type\": \"PG\",\"transactionId\":\"123\","
        ...
        OrderStatusResponse responseToObject =
                OrderStatusResponse.builder()
                        .orderId("OMO2402281351151884090310")
                        .state("COMPLETED")
                        .amount(300)
    ...
    void testTokenFailed() {
        ...
        String url = String.format(StandardCheckoutConstants.ORDER_STATUS_API, merchantOrderId);
        String response =
                "{\"orderId\":\"OMO2402281351151884090310\",\"state\":\"FAILED\",\"amount\":300,"
                    ...
                    + "\"errorCode\":\"AUTHORIZATION_ERROR\",\"splitInstruments\":[{\"instrument\""
                    + " : {\"type\":\"CREDIT_CARD\",\"bankTransactionId\":\"123\",\"bankId\":\"bankId\",\"brn\":\"brn\",\"arn\":\"arn\"},"
                    + " \"rail\":{\"type\": \"PG\",\"transactionId\":\"123\","
                    + "\"authorizationCode\":\"123\",\"serviceTransactionId\":\"123\"},\"amount\":300}]}]}";
        addStubForGetRequest(
    ...
    void testCardSuccess() {
        ...
        String response =
                "{\"orderId\":\"OMO2402281351151884090310\",\"state\":\"COMPLETED\",\"amount\":300,"
                    + "\"expireAt\":1709108893,\"metaInfo\":{\"udf1\":\"udf1\"},"
                    + "\"paymentDetails\":[{\"transactionId\":\"OM2402281351157894090178\","
                    + "\"paymentMode\":\"CARD\",\"timestamp\":1709108475,\"amount\":300,\"state\":\"COMPLETED\",\"splitInstruments\":[{\"instrument\""
                    + " : {\"type\":\"CREDIT_CARD\",\"bankTransactionId\":\"123\",\"bankId\":\"bankId\",\"brn\":\"brn\",\"arn\":\"arn\"},"
                    + " \"rail\":{\"type\": \"PG\",\"transactionId\":\"123\","
                    + "\"authorizationCode\":\"123\",\"serviceTransactionId\":\"123\"},\"amount\":300}]}]}";
        addStubForGetRequest(
    ...
    void testNetbankingSuccess() {
        ...
        String response =
                "{\"orderId\":\"OMO2402281351151884090310\",\"state\":\"COMPLETED\",\"amount\":300,"
                    + "\"expireAt\":1709108893,\"metaInfo\":{\"udf1\":\"udf1\"},"
                    + "\"paymentDetails\":[{\"transactionId\":\"OM2402281351157894090178\","
                    + "\"paymentMode\":\"NET_BANKING\",\"timestamp\":1709108475,\"amount\":300,\"state\":\"COMPLETED\",\"splitInstruments\":[{\"instrument\""
                    + " : {\"type\":\"NET_BANKING\",\"bankTransactionId\":\"123\",\"bankId\":\"bankId\",\"brn\":\"brn\",\"arn\":\"arn\"},"
                    + " \"rail\":{\"type\": \"PG\",\"transactionId\":\"123\","
                    + "\"authorizationCode\":\"123\",\"serviceTransactionId\":\"123\"},\"amount\":300}]}]}";
        addStubForGetRequest(
                url,
    ...
    void testPaymentDetails2Attempts() {
        ...
        String url = String.format(StandardCheckoutConstants.ORDER_STATUS_API, merchantOrderId);
        String response =
                "{\"orderId\":\"OMO2402281351151884090310\",\"state\":\"COMPLETED\",\"amount\":100,"
                    + "\"expireAt\":1709108893,\"metaInfo\":{\"udf1\":\"udf1\"},"
                    + "\"paymentDetails\":[{\"transactionId\":\"OM2402281351157894090178\","
                    + "\"paymentMode\":\"UPI_INTENT\",\"timestamp\":1709108475,\"amount\":100,\"state\":\"FAILED\",\"errorCode\""
                    + " : \"PAYMENT_ERROR\", \"detailedErrorCode\": \"TXN_AUTO_FAILED\"},"
                    + "{\"transactionId\":\"OM2402281351157894090179\","
                    + "\"paymentMode\":\"NET_BANKING\",\"timestamp\":1709108475,\"amount\":100,\"state\":\"COMPLETED\",\"splitInstruments\":[{\"instrument\""
                    + " : {\"type\":\"NET_BANKING\",\"bankTransactionId\":\"123\",\"bankId\":\"bankId\",\"brn\":\"brn\",\"arn\":\"arn\"},"
                    + " \"rail\":{\"type\": \"PG\",\"transactionId\":\"123\","
    ...
    void testPpeIntent() {
        ...
        String response =
                "{\"orderId\":\"OMO2402281351151884090310\",\"state\":\"COMPLETED\",\"amount\":300,"
                    + "\"expireAt\":1709108893,\"metaInfo\":{\"udf1\":\"udf1\"},"
                    + "\"paymentDetails\":[{\"transactionId\":\"OM2402281351157894090178\","
                    + "\"paymentMode\":\"PPE_INTENT\",\"timestamp\":1709108475,\"amount\":300,\"state\":\"COMPLETED\",\"splitInstruments\":[{\"instrument\""
                    + " : {\"type\":\"WALLET\"}, \"rail\":{\"type\": \"PPI_WALLET\"},"
                    + "\"amount\":300}]}]}";
    ...
    void testSubscriptionOrderStatus() {
        ...
        String response =
                "{\"merchantId\": \"MID123\", \"merchantOrderId\": \"MO1708797962855\","
                    ...
                    + " \"OM2402242336055865042862\", \"paymentMode\": \"UPI_INTENT\","
                    + " \"timestamp\": 1708797965588, \"amount\": 200, \"state\": \"COMPLETED\","
                    + " \"splitInstruments\":[{\"instrument\": {\"type\": \"ACCOUNT\","
                    + " \"maskedAccountNumber\": \"XXXXXXX20000\", \"ifsc\": \"AABE0000000\","
                    + " \"accountHolderName\": \"AABE0000000\", \"accountType\": \"SAVINGS\"},"
                    + " \"rail\": {\"type\": \"UPI\", \"utr\": \"405554491450\", \"vpa\":"
                    + " \"8668594479@ybl\"},\"amount\":200}], \"errorCode\": \"PRESENT ONLY IF"
                    + " TRANSACTION IS FAILED\", \"detailedErrorCode\": \"PRESENT ONLY IF"
