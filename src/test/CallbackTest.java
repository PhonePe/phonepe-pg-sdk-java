...
public class CallbackTest extends BaseSetup {
    ...
    void test_ENTIRE_PG_ORDER_COMPLETED() {
        String jsonString = "{\"event\":\"pg.order.completed\",\"payload\":"
        ...
        CallbackResponse expected = CallbackResponse.builder()
                .event("pg.order.completed")
                .payload(CallbackData.builder()
                        .orderId("OMOxx")
                        ...
                        .paymentDetails(Arrays.asList(PaymentDetail.builder()
                                .paymentMode(PgV2InstrumentType.UPI_COLLECT)
                                .timestamp(12121212)
                                .amount(10000)
                                .transactionId("OM12333")
                                .state("FAILED")
                        ...
                        .build())
                .build();
        CallbackResponse actual = standardCheckoutClient.validateCallback("username", "password",
                "bc842c31a9e54efe320d30d948be61291f3ceee4766e36ab25fa65243cd76e0e", jsonString);
        Assertions.assertEquals(expected, actual);
    }

    @Test
    void testCHECKOUT_TRANSACTION_ATTEMPTED_FAILED() {
        String jsonString = "{\"event\":\"checkout.transaction.attempt.failed\",\"payload\":"
    ...
    void testPG_ORDER_FAILED() {
        String jsonString = "{\"event\":\"pg.order.failed\",\"payload\":"
                + "{\"orderId\":\"OMOxx\",\"paymentDetails\":"
                + "[{\"paymentMode\":\"UPI_COLLECT\"}]}}";
    ...
    void testPG_TRANSACTION_ATTEMPT_FAILED() {
        String jsonString = "{\"event\":\"pg.transaction.attempt.failed\",\"payload\":"
                + "{\"orderId\":\"OMOxx\",\"paymentDetails\":"
                + "[{\"paymentMode\":\"UPI_COLLECT\"}]}}";
    ...
    void testPG_REFUND_FAILED() {
        String jsonString = "{\"event\":\"pg.refund.failed\",\"payload\":"
                + "{\"orderId\":\"OMOxx\",\"paymentDetails\":"
                + "[{\"paymentMode\":\"UPI_COLLECT\"}]}}";
    ...
    void testPG_REFUND_COMPLETED() {
        String jsonString = "{\"event\":\"pg.refund.completed\",\"payload\":"
                + "{\"orderId\":\"OMOxx\",\"paymentDetails\":"
                + "[{\"paymentMode\":\"UPI_COLLECT\"}]}}";
    ...
    void testPG_REFUND_ACCEPTED() {
        String jsonString = "{\"event\":\"pg.refund.accepted\",\"payload\":"
                + "{\"orderId\":\"OMOxx\",\"paymentDetails\":"
                + "[{\"paymentMode\":\"UPI_COLLECT\"}]}}";
    ...
    void testCHECKOUT_ORDER_COMPLETED() {
        String jsonString = "{\"event\":\"checkout.order.completed\",\"payload\":"
                + "{\"orderId\":\"OMOxx\",\"paymentDetails\":"
                + "[{\"paymentMode\":\"UPI_COLLECT\"}]}}";
    ...
    void testCHECKOUT_ORDER_FAILED() {
        String jsonString = "{\"event\":\"checkout.order.failed\",\"payload\":"
                + "{\"orderId\":\"OMOxx\",\"paymentDetails\":"
                + "[{\"paymentMode\":\"UPI_COLLECT\"}]}}";
                ...
                .payload(CallbackData.builder()
                        ...
                        .paymentDetails(Arrays.asList(PaymentDetail.builder()
                                ...
                                .splitInstruments(Arrays.asList(InstrumentCombo.builder()
                                        .rail(PpiEgvPaymentRail.builder()
                                                .build())
                                        .instrument(DebitCardPaymentInstrumentV2.builder()
                                                .arn("arn")
                                                .brn("brn")
                                                .bankId("bankId")
                                                .bankTransactionId("bankTransactionId")
    ...
    void validateCallbackCustom() {
        ...
        CallbackResponse expected = CallbackResponse.builder()
                ...
                .payload(CallbackData.builder()
                        ...
                        .build())
                .build();
        CallbackResponse actual = customCheckoutClient.validateCallback("username", "password",
                "bc842c31a9e54efe320d30d948be61291f3ceee4766e36ab25fa65243cd76e0e", jsonString);
        Assertions.assertEquals(expected, actual);
    }
    ...
    void validateCallbackSubscription() {
        String jsonString = "{\"event\": \"subscription.cancelled\", \"payload\": {\"merchantSubscriptionId\": "
                + "\"MS1708797962855\", \"subscriptionId\": \"OMS2402242336054995042603\", \"state\": \"CANCELLED\", "
                + "\"authWorkflowType\": \"TRANSACTION\", \"amountType\": \"FIXED\", \"maxAmount\": 200, "
                + "\"frequency\": \"ON_DEMAND\", "
                + "\"expireAt\": 1737278524000, \"pauseStartDate\": 1708798426196, \"pauseEndDate\": 1708885799000}}";
        CallbackResponse expected = CallbackResponse.builder()
        ...
        CallbackResponse actual = subscriptionClient.validateCallback("username", "password",
                "bc842c31a9e54efe320d30d948be61291f3ceee4766e36ab25fa65243cd76e0e", jsonString);
        Assertions.assertEquals(expected, actual);
    }
    ...
    void subscriptionSetupSuccess() {
        String jsonString = "{\"event\": \"subscription.setup.order.completed\", \"payload\": {\"merchantId\": "
                + "\"SWIGGY8\", \"merchantOrderId\": \"MO1708797962855\", \"orderId\": \"OMO2402242336055135042802\","
                + " \"state\": \"COMPLETED\", \"amount\": 200, \"expireAt\": 1708798385505, \"paymentFlow\": "
                + "{\"type\": \"SUBSCRIPTION_SETUP\", \"merchantSubscriptionId\": \"MS1708797962855\", "
                + "\"authWorkflowType\": \"TRANSACTION\", \"amountType\": \"FIXED\", \"maxAmount\": 200, "
                + "\"frequency\": \"ON_DEMAND\", \"subscriptionId\": \"OMS2402242336054995042603\"}, \"errorCode\": "
                + "\"<PRESENT ONLY IF STATE IS FAILED>\", \"detailedErrorCode\": \"<PRESENT ONLY IF STATE IS "
                + "FAILED>\", \"paymentDetails\": [{\"transactionId\": \"OM2402242336055865042862\", \"paymentMode\":"
                + " \"UPI_INTENT\", \"timestamp\": 1708797965588, \"amount\": 200, \"state\": \"COMPLETED\", "
                + "\"splitInstruments\":[{\"instrument\": {\"type\": \"ACCOUNT\", \"maskedAccountNumber\": "
                + "\"XXXXXXX20000\", \"ifsc\": "
                + "\"AABE0000000\", \"accountHolderName\": \"AABE0000000\", \"accountType\": \"SAVINGS\"}, \"rail\": "
                + "{\"type\": \"UPI\", \"utr\": \"405554491450\", \"vpa\": \"8668594479@ybl\", \"umn\": "
                + "\"d519347eb2374125bcad6e69a42cc13b@ybl\"},\"amount\":200}], \"errorCode\": \"<PRESENT ONLY IF "
                + "TRANSACTION IS "
                + "FAILED>\", \"detailedErrorCode\": \"<PRESENT ONLY IF TRANSACTION IS FAILED>\"}]}}";
    ...
    void testNotifyValidate() {
        String jsonString = "{\"event\": \"subscription.notification.completed\", "
                + "\"payload\": {\"merchantId\": \"SWIGGY8\", \"merchantOrderId\": \"MO1708797962855\", \"orderId\": "
                + "\"OMO12344\", \"amount\": 100, \"state\": \"NOTIFIED\", \"expireAt\": 1620891733101, \"metaInfo\":"
                + " {\"udf1\": \"<some meta info of max length 256>\", \"udf2\": \"<some meta info of max length "
                + "256>\", \"udf3\": \"<some meta info of max length 256>\", \"udf4\": \"<some meta info of max "
                + "length 256>\", \"udf5\": \"<some meta info of max length 256>\"}, \"paymentFlow\": {\"type\": "
                + "\"SUBSCRIPTION_REDEMPTION\", \"merchantSubscriptionId\": \"MS121312\", "
                + "\"redemptionRetryStrategy\": \"CUSTOM\", \"autoDebit\": true, \"validAfter\": \"1628229131000\", "
                + "\"validUpto\": \"1628574731000\", \"notifiedAt\": \"1622539751586\"}}}";
        ...
        CallbackResponse expected = CallbackResponse.builder()
                ...
                .payload(CallbackData.builder()
                        ...
                        .metaInfo(MetaInfo.builder()
                                ...
                                .build())
                        .paymentFlow(SubscriptionRedemptionPaymentFlowResponse.builder()
                                .merchantSubscriptionId("MS121312")
                                .redemptionRetryStrategy(RedemptionRetryStrategy.CUSTOM)
                                .autoDebit(true)
